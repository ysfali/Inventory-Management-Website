  ...
  <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <nav class="navbar navbar-default marginTop">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle marginLeft" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Billing<span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="purchases.php">Purchases</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a href="billdetails.php">Bill Details</a></li>
                </ul>
              </li>
              <li class="dropdown">
      ...
      <div class="container contentContainer">
        <div class="jumbotron white">
          ...
          <p class="lead center marginTop"></p>
        </div>
      </div>
