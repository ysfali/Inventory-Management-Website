  ...
  <body data-spy="scroll" data-target=".navbar-collapse">
      ...
      <div class="container contentContainer">
        <div class="jumbotron white">
          <h1 class="center">Remove Employee</h1>
          <p class="lead center marginTop">Enter the details</p>
          <?php
              if(isset($error))
              {
                if($error!="")
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="text" name="empid" value="<?php if(isset($_POST['empid'])) echo $_POST['empid'] ?>" class="form-control"/>
            </div>
            ...
            <div class="form-group">
              <label for="adppassword">Password</label>
              <input type="password" name="adpassword" value="<?php if(isset($_POST['adpassword'])) echo $_POST['adpassword'] ?>" class="form-control"/>
            </div>
            <div class="form-group">
