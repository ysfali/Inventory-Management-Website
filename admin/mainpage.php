...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".navbar-collapse">
      ...
      <div class="container contentContainer">
        <div class="jumbotron">
          <h1 class="center">This is the Administration Panel</h1>
          <p class="lead center marginTop">The Admin has complete control over the whole management of the website.</p>
        </div>
      </div>
    ...
    <script>
      $(".jumbotron").css("min-height",$(window).height()*2/3);
    </script>
  </body>
</html>